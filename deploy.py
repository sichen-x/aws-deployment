...
def deploy(key, hostname, prefix):
    ...
    copy_repo_2_server(ssh, 'https://github.com/sichen-x/aws-deployment.git')
    ssh.exec_command('python '+'~/aws-deployment/process_json.py '+prefix)
    set_crontab(ssh, '~/aws-deployment', 'log_rotate.py', prefix)
    ssh.close() # log out  
